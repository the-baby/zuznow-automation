...
.then( _ => z.assertExists(By.css('div.src-component-submitTicket-SubmitTicketForm-formWrapper input[name="name"]'), "support ticket" ) )
.then( _ => z.assertExists(By.css('div.src-component-submitTicket-SubmitTicketForm-formWrapper textarea[name="description"'), "support ticket" ) )
//.then( _ => z.clickByCss('.src-component-button-ButtonSecondary-button') )
.then( _ => z.clickByCss('.src-component-button-ButtonNav-button.u-posStart--vertFlush.u-posEnd--flush') )
.catch( z.failedScenario )
