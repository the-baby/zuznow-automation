...
.then( _ => z.waitFor(3) )
.then( _ => z.switchTab(2, 'open support ticket page'))
.then( _ => z.clickByLinkText('Open a New Ticket') )
.then( _ => z.assertExists(By.linkText('Create an account'), "support ticket form" ) )
.catch( z.failedScenario )
...
.then( _ => z.switchTab(3, 'opened ticket form'))
.then( _ => z.assertExists(By.linkText('Open a New Ticket'), "share your thoughts" ) )
.catch( z.failedScenario )
