...
.then( _ => z.waitFor(4))
.then( () => z.assertContainsText(By.id('conv-wrap'), "the expected text in the element", 'IKEA offers a flat rate online delivery service to your home or business starting at $9 for small item shipping and $39 for large item delivery.') )
.catch( z.failedScenario )
